...
static void mt7621_i2c_init(void)
{
	...
	mt7621_i2c_regs = ioremap(0x1E000900, sizeof(struct mt7621_i2c_regs));

    printk("init mt7621 i2c....\n");
    /* ctrl0 */
	reg = ODRAIN_HIGH_SM0 | VSYNC_PULSE | (clk_div << CLK_DIV_SHIFT) |
		WAIT_HIGH | SM0_EN;  
	mtk_i2c_w32(mt7621_i2c_regs, reg, REG_SM0CTL0); 
	
	/* auto mode */
	mtk_i2c_w32(mt7621_i2c_regs, AUTOMODE_EN, REG_SM0CFG2);
...
static int i2c_bus_mt7621_init(void)
{
	...
	printk("exit i2c_bus_mt7621_init\n");
	return 0;
}
